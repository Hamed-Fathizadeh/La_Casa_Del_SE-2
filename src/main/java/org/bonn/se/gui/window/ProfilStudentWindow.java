...
public class ProfilStudentWindow extends Window {
    private final Image image = new Image();


    public ProfilStudentWindow(Student user)  {
        setWindow1(user);
    }

    public void setWindow1(Student user)  {
...
//        gridLayout.addComponent(head, 0, 0, 1, 0);
    ...
    public void setWindow2(Student user) {
        center();
        ...
        Label head = new Label("<h1><p><font color=\"blue\"> Bisherige Berufe</font></p></h1>", ContentMode.HTML);
        head.setHeight("70px");
        ...
        gridLayout.addComponent(skip, 0, 9, 0, 9);
        gridLayout.addComponent(weiter, 2, 9, 2, 9);
        gridLayout.setComponentAlignment(skip,Alignment.TOP_CENTER);
        gridLayout.setComponentAlignment(weiter,Alignment.TOP_LEFT);

        setContent(gridLayout);
        gridLayout.setComponentAlignment(head, Alignment.TOP_CENTER);


        binder.addStatusChangeListener(event -> weiter.setEnabled(binder.isValid()));
    ...
    private void setWindow3(Student user) {
        ...
        Label label1 = new Label("<h1><p><font color=\"blue\">Skills und Kenntnisse</font></p></h1>",ContentMode.HTML);
        label1.setHeight("56px");
        gridLayout.addComponent(label1,0,0,4,0);
        gridLayout.setComponentAlignment(label1,Alignment.TOP_CENTER);
        ...
        gridLayout.addComponent(fertig,3,9,3,9);

        Button skip = new Button("Überspringen & zum Profil");
        skip.setWidth("280px");
        gridLayout.addComponent(skip,1,9,1,9);
        gridLayout.setComponentAlignment(skip,Alignment.MIDDLE_CENTER);
        ...
        skip.addClickListener(new Button.ClickListener() {
            ...
            public void buttonClick(Button.ClickEvent event) {
                try {
                    UI.getCurrent().getSession().setAttribute(Roles.Student,ProfilDAO.getStudent(user.getEmail()));
                } catch (DatabaseException e) {
                    e.printStackTrace();
                }
                ProfilStudentWindow.this.close();
        ...
        binder.addStatusChangeListener(event -> fertig.setEnabled(binder.isValid()));
        binder1.addStatusChangeListener(event -> fertig.setEnabled(binder.isValid()));
