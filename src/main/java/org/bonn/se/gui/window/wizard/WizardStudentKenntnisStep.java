        ...
        public Component getContent() {
            ...
            plus.addClickListener((Button.ClickListener) event -> {
                ...
                if (binder.isValid()) {
                    ...
                    gridLayout.addComponent(new ComboBoxNiveau("",DatenStudentProfil.getCollection3()), i_c[1], i_r[0]);
            ...
            plus1.addClickListener((Button.ClickListener) event -> {
                ...
                if (binder1.isValid()) {
                    ...
                    gridLayout.addComponent(new ComboBoxNiveau("",DatenStudentProfil.getCollection2()), j_c[4], j_r[0]);
