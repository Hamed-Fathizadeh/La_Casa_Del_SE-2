...
public class DatenUnternehmenProfil {
    ...
    public static final Collection<String> branche1  = new ArrayList<>(Arrays.asList(
...
// --Commented out by Inspection STOP (22.06.20, 23:36)
    ...
    public static final   Collection<String>  status = new ArrayList<>(Arrays.asList(
            "status1",
            "status2"
    ));
    public static final   Collection<String>  einstellungsart  = new ArrayList<>(Arrays.asList(
            "Feste Anstellung",
            "Befristeter Vertrag",
            "Praktikum",
            "Werkstudent",
